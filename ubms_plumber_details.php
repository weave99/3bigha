...
<div class="mt-5">
    <div class="container">
        ...
        */
        ...
        //`plumber_id`, `user_id`, `services_name`, `unit`, `price`, `decription`, `payment_options` 
        ...
        if(isset($_POST['search_services']) && $_POST['search_services']!="")
          {
            ...
            $sql_show="SELECT * FROM ubms_plumber where services_name='$search_services' ";
          }
          else
              $sql_show="SELECT * FROM ubms_plumber order by  services_name";
                    ...
                    <div class="detail">
                        ...
                        <div class="row pb-4">
                            ...
                            <div class="col-lg-12">
                                ...
                                <button onclick="ShowDetails(<?php echo $plumber_id;?>)" class="btn  btn-primary">More Details</button>

                                <div id="<?php echo $plumber_id;?>" class="mt-4" style="display:none;">
                                <?php
                                 /*
                                `user_id`, `full_name`, `business_name`, `profile_picture`, `state`, `district`, `city`,
                                `location_office`, `current_location`, `working_days`, `opening_time`, `close_time`, 

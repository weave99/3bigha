...
<head>
    <title>3 BIGHA | Exterior Designer</title>
...
<div class="sub-banner">
    <div class="container">
        <div class="breadcrumb-area">
            <h1>Exterior Designer</h1>
            <ul class="breadcrumbs">
                <li><a href="index.html">Home</a></li>
                <li class="active">Exterior Designer</li>
            </ul>
        </div>
    </div>
</div>
...
<div class="mt-5">
    <div class="container">
        ...
        */
        ...
        //`exterior_designer_id`, `user_id`, `services_name`, `unit`, `price`, `decription`, `payment_options` 
        ...
        if(isset($_POST['search_services']) && $_POST['search_services']!="")
          {
            ...
            $sql_show="SELECT * FROM ubms_exterior_designer where services_name='$search_services' ";
          }
          else
              $sql_show="SELECT * FROM ubms_exterior_designer order by  services_name";
            ...
            {
                $exterior_designer_id=$show['exterior_designer_id'];
                    ...
                    <div class="detail">
                        ...
                        <div class="row pb-4">
                            ...
                            <div class="col-lg-12">
                                ...
                                <button onclick="ShowDetails(<?php echo $exterior_designer_id;?>)" class="btn  btn-primary">More Details</button>

                                <div id="<?php echo $exterior_designer_id;?>" class="mt-4" style="display:none;">
                                <?php
                                 /*
                                `user_id`, `full_name`, `business_name`, `profile_picture`, `state`, `district`, `city`,
                                `location_office`, `current_location`, `working_days`, `opening_time`, `close_time`, 

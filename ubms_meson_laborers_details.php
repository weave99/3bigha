...
<head>
    <title>3 BIGHA | Meson / Laborers</title>
...
<div class="sub-banner">
    <div class="container">
        <div class="breadcrumb-area">
            <h1>Meson / Laborers</h1>
            <ul class="breadcrumbs">
                <li><a href="index.html">Home</a></li>
                <li class="active">Meson / Laborers</li>
            </ul>
        </div>
    </div>
</div>
        ...
        if(isset($_POST['search_services']) && $_POST['search_services']!="")
          {
            ...
            $sql_show="SELECT * FROM ubms_meson_laborers where services_name='$search_services' ";
          }
          else
              $sql_show="SELECT * FROM ubms_meson_laborers order by  services_name";
            ...
            {
                $meson_laborers_id=$show['meson_laborers_id'];
                    ...
                    <div class="detail">
                        ...
                        <div class="row pb-4">
                            ...
                            <div class="col-lg-12">
                                ...
                                <button onclick="ShowDetails(<?php echo $meson_laborers_id;?>)" class="btn  btn-primary">More Details</button>

                                <div id="<?php echo $meson_laborers_id;?>" class="mt-4" style="display:none;">
                                <?php
                                 /*
                                `user_id`, `full_name`, `business_name`, `profile_picture`, `state`, `district`, `city`,
                                `location_office`, `current_location`, `working_days`, `opening_time`, `close_time`, 

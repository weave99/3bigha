...
<head>
    <title>3 BIGHA | Cabinet Maker</title>
    ...
    <div class="container">
        <div class="breadcrumb-area">
            ...
            <ul class="breadcrumbs">
                ...
                <li class="active">Cabinet Maker</li>
            </ul>
        </div>
    </div>
</div>
...
<div class="mt-5">
    <div class="container">
        ...
        */
        ...
        //`cabinet_maker_id`, `user_id`, `services_name`, `unit`, `price`, `decription`, `payment_options` 
        ...
        if(isset($_POST['search_services']) && $_POST['search_services']!="")
          {
            ...
            $sql_show="SELECT * FROM ubms_cabinet_maker where services_name='$search_services' ";
          }
          else
              $sql_show="SELECT * FROM ubms_cabinet_maker order by  services_name";
            ...
            {
                $cabinet_maker_id=$show['cabinet_maker_id'];
                    ...
                    <div class="detail">
                        ...
                        <div class="row pb-4">
                            ...
                            <div class="col-lg-12">
                                ...
                                <button onclick="ShowDetails(<?php echo $cabinet_maker_id;?>)" class="btn  btn-primary">More Details</button>

                                <div id="<?php echo $cabinet_maker_id;?>" class="mt-4" style="display:none;">
                                <?php
                                 /*
                                `user_id`, `full_name`, `business_name`, `profile_picture`, `state`, `district`, `city`,
                                `location_office`, `current_location`, `working_days`, `opening_time`, `close_time`, 

...
<head>
    <title>3 BIGHA | General Contractor</title>
    ...
    <div class="container">
        <div class="breadcrumb-area">
            ...
            <ul class="breadcrumbs">
                ...
                <li class="active">General Contractor</li>
            </ul>
        </div>
    </div>
</div>
...
<div class="mt-5">
    <div class="container">
        ...
        */
        ...
        //`general_contractor_id`, `user_id`, `services_name`, `unit`, `price`, `decription`, `payment_options` 
        ...
        if(isset($_POST['search_services']) && $_POST['search_services']!="")
          {
            ...
            $sql_show="SELECT * FROM ubms_general_contractor where services_name='$search_services' ";
          }
          else
              $sql_show="SELECT * FROM ubms_general_contractor order by  services_name";
            ...
            {
                $general_contractor_id=$show['general_contractor_id'];
                    ...
                    <div class="detail">
                        ...
                        <div class="row pb-4">
                            ...
                            <div class="col-lg-12">
                                ...
                                <button onclick="ShowDetails(<?php echo $general_contractor_id;?>)" class="btn  btn-primary">More Details</button>

                                <div id="<?php echo $general_contractor_id;?>" class="mt-4" style="display:none;">
                                <?php
                                 /*
                                `user_id`, `full_name`, `business_name`, `profile_picture`, `state`, `district`, `city`,
                                `location_office`, `current_location`, `working_days`, `opening_time`, `close_time`, 

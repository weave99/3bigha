            ...
            <div class="ibox bg-success color-white widget-stat">
                <div class="ibox-body">
                    <h2 class="m-b-5 font-strong">
                        ...
                        $live_property_sql = "SELECT * FROM users_post_property_details where live_status='1'";
            ...
            <div class="ibox bg-danger color-white widget-stat">
                <div class="ibox-body">
                    <h2 class="m-b-5 font-strong">
                        ...
                        //`order_id`, `trans_no`, `trans_date`, `amount`, `user_id`, `txn_status`, `clnt_txn_ref`, `shipping_name`, `shipping_street`, `shipping_city`, `shipping_state_country`, `shipping_pin_code`, `shipping_mobile`, `shipping_email` 
                        //SELECT * FROM `customer_order` WHERE 1
                        $reject_status_sql = "SELECT * FROM users_post_property_details where reject_status='1'";
            ...
            <div class="ibox bg-warning color-white widget-stat">
                <div class="ibox-body">
                    <h2 class="m-b-5 font-strong">
                        ...
                        //`order_id`, `trans_no`, `trans_date`, `amount`, `user_id`, `txn_status`, `clnt_txn_ref`, `shipping_name`, `shipping_street`, `shipping_city`, `shipping_state_country`, `shipping_pin_code`, `shipping_mobile`, `shipping_email` 
                        //SELECT * FROM `customer_order` WHERE 1
                        $under_review_sql = "SELECT * FROM users_post_property_details where under_review='0'";

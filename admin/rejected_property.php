...
if(isset($_POST['request_accepted']))	
{
        ...
        $reject ="UPDATE users_post_property_details SET  reject_status=0, live_status=1 where post_property_id='$request_property_id'";
...
<div class="page-content fade-in-up">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Rejected Property</div>
                ...
                <div class="ibox-body">
                    <table class="table table-striped table-hover">
                        ...
                        $post_property_sql="SELECT * FROM users_post_property_details where reject_status='1' order by post_date desc";
                        ...
                        ?>
                            ...
                            <td><?php echo $full_name;?></td>
                                ...
                                <td>
                                <?php
                                    if($post_property_details['under_review']==1){
                                    ?>
                                ...
                                <td>
                                    <form action="" method="post">
                                        <input type="hidden" name="request_property_id" value="<?php echo $post_property_details['post_property_id'];?>">

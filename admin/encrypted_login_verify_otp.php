...
if(isset($_POST['verify']))	
{
    ...
    if ($result->num_rows > 0) {
        ...
        $sql="SELECT * FROM admin WHERE verify_otp='$verify_otp'";
        $query=mysqli_query($conn,$sql);
        if($r=mysqli_fetch_array($query))
        {
            mysqli_query($conn,"UPDATE admin set verify_otp='" . NULL . "' where email='$email'");
            ...
            header("location:dashboard.php");
                ...
                header("location:encrypted_login_verify_otp.php?email=".$email."&msg=Invalide Code");
            }
    } 
    else {

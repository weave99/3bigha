...
if(isset($_POST['request_accepted']))	
{
      ...
      $update ="UPDATE users_post_property_details SET under_review=1 where post_property_id='$request_property_id'";
      if ($conn->query($update) === TRUE) {

            $accepted ="UPDATE users_post_property_details SET live_status=1 where post_property_id='$request_property_id'";
...
if(isset($_POST['request_reject']))	
{
      ...
      if ($conn->query($update) === TRUE) {
            ...
            $accepted ="UPDATE users_post_property_details SET reject_status=1 where post_property_id='$request_property_id'";
            if ($conn->query($accepted) === TRUE) {
                $err="Successfully Accepted";
                header("location:dashboard.php?msg=".$err);
            }
            ...
            <div class="page-content fade-in-up">
                <div class="row">
                    <div class="col-md-12">
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">About property </div>
                                        ...
                                        <div class="row p-5">
                                            <div class="col-lg-12 text-center">
                                                <form action="" method="post">
                                                    <input type="hidden" name="request_property_id" value="<?php echo  $post_property_id;?>">
                                                    <button class="btn btn-danger" name="request_reject">Request Reject</button>
                                                    <button class="btn btn-success" name="request_accepted">Request Accepted</button>
                                                </form>
                                            </div>
                                        </div>
                                </div>

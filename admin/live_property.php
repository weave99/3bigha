...
<div class="page-content fade-in-up">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Live Property</div>
                ...
                <div class="ibox-body">
                    <table class="table table-striped table-hover">
                        ...
                        $post_property_sql="SELECT * FROM users_post_property_details where live_status='1' order by post_date desc";
                            ...
                            <td><?php echo $full_name;?></td>
                                ...
                                <td>
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <button class="btn btn-danger" name="request_reject">Reject Property</button>

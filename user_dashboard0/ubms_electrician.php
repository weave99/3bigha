...
if($fetch=mysqli_fetch_array($select_query)) {
  ...
  //`electrician_id`, `services_name`, `unit`, `price`, `decription`, `payment_options` 
  //SELECT * FROM `ubms_electrician` WHERE 1

  if(isset($_POST['delete']))	
  {
         $electrician_id=$_POST['electrician_id'];
         
        $qury=mysqli_query($conn,"DELETE FROM `ubms_electrician` WHERE electrician_id='$electrician_id'");
        header("location:ubms_electrician.php?err=Successfully deleted");
  ...
  if(isset($_POST['submit']))
  {
      ...
      $sql="INSERT INTO ubms_electrician (user_id, services_name, unit, price, decription, payment_options)
      VALUES ('$user_id', '$services_name', '$unit', '$price' , '$decription' , '$payment_options')";
      $query=mysqli_query($conn,$sql);
      if($query){
      
          header("Location:ubms_electrician.php?msg=New record submited successfully");
  ...
  if(isset($_POST['update']))
  {
          ...
          $electrician_id=trim($_POST['electrician_id']);
          $services_name= $_POST['services_name'] ;
          $unit= $_POST['unit'] ;
          $price= $_POST['price'] ;
          $decription= $_POST['decription'] ;
          ...
          $update=mysqli_query($conn,"update  ubms_electrician  set services_name='$services_name', unit='$unit', price='$price', decription='$decription', payment_options='$payment_options'  where electrician_id='$electrician_id'");
                 
  
      if($update)
      {
          header("location:ubms_electrician.php?msg=Updated Successfully");
      }
      else
      {
          $err=mysql_error();
    ...
    <?php if(isset($_REQUEST['xedit']))
         {
              //`electrician_id`, `services_name`, `unit`, `price`, `decription`, `payment_options` 
                //SELECT * FROM `ubms_electrician` WHERE 1
           $electrician_id=$_REQUEST['electrician_id'];
		   $qre=mysqli_query($conn,"SELECT * FROM ubms_electrician where electrician_id=$electrician_id");
		   if($fetch=mysqli_fetch_array($qre))
			{
              $electrician_id=$fetch['electrician_id'];
            ...
            <div class="page-content fade-in-up">
                <div class="row">
                    <div class="col-md-12">
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">Electrician Services</div>
                            ...
                            <?php
                                    ...
                                    ?>
                            <!--
                                  //`electrician_id`, `sub_type`, `services_name`, `unit`, `price`, `decription`, 
                                    //`payment_options` SELECT * FROM `ubms_electrician` WHERE 1

                            -->
                            <div class="ibox-body">
                                <form action="" method="POST">
                                <input type="hidden" id="electrician_id" name="electrician_id"  readonly="readonly" value="<?php if(isset($_REQUEST['xedit'])) {echo $electrician_id;}?>" />    
                                <div class="row">
                                    <div class="col-lg-4 form-group">
                                        ...
                                        $sql_ctgy="SELECT * FROM `users_services_name_master` WHERE account_sub_type='Electrician'";
                            ...
                            <div class="ibox-body">
                                <table class="table table-striped table-hover">
                                    ...
                                    <?php
                                        ...
                                        $sql="SELECT * FROM `ubms_electrician` WHERE user_id=$user_id order by electrician_id DESC";
                                        $query=mysqli_query($conn,$sql);
                                        ...
                                        {?>
                                            ...
                                            <tr>
                                                ...
                                                <form method="post" action="" enctype="multipart/form-data" onsubmit="return myFunction();">          
                                                    <input type="hidden" name="electrician_id" value="<?php echo $prod['electrician_id'];?>" />

                                                <td class="d-flex"><a href="ubms_electrician.php?xedit=1&electrician_id=<?php echo $prod['electrician_id'];?>"><i class="fa fa-pencil-square" aria-hidden="true" style="font-size:25px;"></i></a><button  style="border:none; color:#007bff" type="submit" name="delete"><i class="fa fa-trash" aria-hidden="true" style="font-size:25px;"></i></a></button></td>
                                              </form>
                                            </tr>
                                        <?php
                                        }

...
if($fetch=mysqli_fetch_array($select_query)) {
  ...
  //`lawyer_id`, `services_name`, `unit`, `price`, `decription`, `payment_options` 
  //SELECT * FROM `uls_lawyer` WHERE 1

  if(isset($_POST['delete']))	
  {
         $lawyer_id=$_POST['lawyer_id'];
         
        $qury=mysqli_query($conn,"DELETE FROM `uls_lawyer` WHERE lawyer_id='$lawyer_id'");
        header("location:uls_lawyer.php?err=Successfully deleted");
  ...
  if(isset($_POST['submit']))
  {
      ...
      $sql="INSERT INTO uls_lawyer (user_id, services_name, unit, price, decription, payment_options)
      VALUES ('$user_id', '$services_name', '$unit', '$price' , '$decription' , '$payment_options')";
      $query=mysqli_query($conn,$sql);
      if($query){
      
          header("Location:uls_lawyer.php?msg=New record submited successfully");
  ...
  if(isset($_POST['update']))
  {
          ...
          $update=mysqli_query($conn,"update  uls_lawyer  set services_name='$services_name', unit='$unit', price='$price', decription='$decription', payment_options='$payment_options'  where lawyer_id='$lawyer_id'");
                 
  
      if($update)
      {
          header("location:uls_lawyer.php?msg=Updated Successfully");
      }
      else
      {
          $err=mysql_error();
    ...
    <?php if(isset($_REQUEST['xedit']))
         {
		   ...
		   $qre=mysqli_query($conn,"SELECT * FROM uls_lawyer where lawyer_id=$lawyer_id");
            ...
            <div class="page-content fade-in-up">
                <div class="row">
                    <div class="col-md-12">
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">Advocate / Solicitor Services</div>
                            ...
                            <?php
                                    ...
                                    ?>
                            <!--
                                  //`lawyer_id`, `sub_type`, `services_name`, `unit`, `price`, `decription`, 
                                    //`payment_options` SELECT * FROM `uls_lawyer` WHERE 1

                            -->
                            <div class="ibox-body">
                                <form action="" method="POST">
                                <input type="hidden" id="lawyer_id" name="lawyer_id"  readonly="readonly" value="<?php if(isset($_REQUEST['xedit'])) {echo $lawyer_id;}?>" />    
                                <div class="row">
                                    <div class="col-lg-4 form-group">
                                        ...
                                        $sql_ctgy="SELECT * FROM `users_services_name_master` WHERE account_sub_type='Advocate / Solicitor'";
                            ...
                            <div class="ibox-body">
                                <table class="table table-striped table-hover">
                                    ...
                                    <?php
                                        ...
                                        $sql="SELECT * FROM `uls_lawyer` WHERE user_id=$user_id order by lawyer_id DESC";
                                        $query=mysqli_query($conn,$sql);
                                        ...
                                        {?>
                                            ...
                                            <tr>
                                                ...
                                                <form method="post" action="" enctype="multipart/form-data" onsubmit="return myFunction();">          
                                                    <input type="hidden" name="lawyer_id" value="<?php echo $prod['lawyer_id'];?>" />

                                                <td class="d-flex"><a href="uls_lawyer.php?xedit=1&lawyer_id=<?php echo $prod['lawyer_id'];?>"><i class="fa fa-pencil-square" aria-hidden="true" style="font-size:25px;"></i></a><button  style="border:none; color:#007bff" type="submit" name="delete"><i class="fa fa-trash" aria-hidden="true" style="font-size:25px;"></i></a></button></td>
                                              </form>
                                            </tr>
                                        <?php
                                        }

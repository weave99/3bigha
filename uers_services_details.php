...
<head>
    <title>3 BIGHA | Rental Services</title>
...
<!-- Sub banner end -->
    ...
    <div class="container">
        <div class="row mt-5">
            ...
            <div class="col-lg-12">
                <h4>Result For - <?php if(isset($_POST['search_services'])){ if($_POST['search_services']=="")  echo "All Equipments"; else  echo $_POST['search_services'];} else echo "All Equipments";?></h4>
            </div>
        </div>
    </div>
...
<div class="mt-5">
    <div class="container">
        ...
        */
        ...
        //`equipment_id`, `user_id`, `services_name`, `what_it_does`, `capacity`, `equipment_image`,
        // `rate_per`, `price`, `decription`, `payment_options` SELECT * FROM `uers_services` WHERE 1

        if(isset($_POST['search_services']) && $_POST['search_services']!="")
          {
            $search_services=$_POST['search_services'];
            $sql_show="SELECT * FROM uers_services where services_name='$search_services' ";
          }
          else
              $sql_show="SELECT * FROM uers_services order by  services_name";
            ...
            {
                $equipment_id=$show['equipment_id'];
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 mb-5">
                <div class="blog-5">
                    <div class="blog-image">
                        <img src="user_dashboard/equipment_image/<?php echo $show['equipment_image'];?>" alt="img" class="img-fluid">
                    </div>
                    <div class="detail">
                        <h5 class="text-primary">
                        ...
                        <div class="row pb-4">
                            ...
                            <div class="col-lg-12">
                                <h6><b>What it Does :</b> <?php echo $show['what_it_does'];?></h6>
                            </div>
                            <div class="col-lg-12">
                                <h6><b>Capacity :</b> <?php echo $show['capacity'];?></h6>
                                <h6><b>Rate Per :</b> <?php echo $show['rate_per'];?></h6>
                                <h6><b>Price:</b> <?php echo $show['payment_options'];?></h6>
                                <h6><b>Description:</b> <?php echo $show['decription'];?></h6>
                                <h6><b>Payment Options:</b> <?php echo $show['payment_options'];?></h6>
                            </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <button onclick="ShowDetails(<?php echo $equipment_id;?>)" class="btn  btn-primary">More Details</button>

                                <div id="<?php echo $equipment_id;?>" class="mt-4" style="display:none;">
                                <?php
                                 /*
                                `user_id`, `full_name`, `business_name`, `profile_picture`, `state`, `district`, `city`,
                                `location_office`, `current_location`, `working_days`, `opening_time`, `close_time`, 

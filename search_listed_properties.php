...
$sql3="SELECT * FROM users_post_property_details WHERE live_status=1  ";


if(isset($_POST['search_buy'])){
    
    $sql3=$sql3." and property_list='Sell' ";
    ...
    if(isset($_POST['search_data'])){
        ...
        if($search_data!="")
        $sql3=$sql3." and (  property_state='$search_data' or property_district='$search_data' or property_city='$search_data' or property_locality='$search_data' or 
        property_sub_locality='$search_data' or apartment_socity='$search_data' or property_type='$search_data' or property_list='$search_data' )";
    }

    $property_type_land_plot="";
    if(isset($_POST['property_type_land_plot'])){
        $property_type_land_plot=trim($_POST['property_type_land_plot']);

    }
    $property_type_house="";
    if(isset($_POST['property_type_house'])){
        $property_type_house=trim($_POST['property_type_house']);

    }
    if(isset($_POST['property_type_house']) || isset($_POST['property_type_land_plot'])){
        $sql3=$sql3." and ( property_type='$property_type_land_plot' or property_type='$property_type_house' )";        
    }



    $your_budget=0;
    if(isset($_POST['your_budget'])){
        $your_budget=(int)trim($_POST['your_budget']);
        if($your_budget<=5000000)
              $sql3=$sql3." and expected_price>0 and  expected_price<=$your_budget ";
        else  if($your_budget<=10000000)
              $sql3=$sql3." and expected_price>5000000 and  expected_price<=$your_budget "; 
        else  
              $sql3=$sql3." and expected_price>10000000 and  expected_price<=$your_budget "; 
    }
   

    $bedroom_bhk=0;
    if(isset($_POST['bedroom_bhk'])){
        $bedroom_bhk=(int)trim($_POST['bedroom_bhk']);
        $sql3=$sql3." and bedroom_bhk=$bedroom_bhk "; 
    ...
    if(isset($_POST['under_construction_yn'])){
        $under_construction_yn=(int)trim($_POST['under_construction_yn']);
        $sql3=$sql3." and under_construction_yn=$under_construction_yn "; 
    }


    $best_deal="";
    if(isset($_POST['best_deal'])){
        $best_deal=trim($_POST['best_deal']);
        $sql3=$sql3." and best_deal!='' "; 

    }
    $hot_offer="";
    if(isset($_POST['hot_offer'])){
        $hot_offer=trim($_POST['hot_offer']);
        $sql3=$sql3." and hot_offer!='' "; 
    }
    
    //`user_id`, `full_name`, `business_name`, `profile_picture`, `state`, `district`, `city`, `location_office`, `current_location`, `working_days`, `opening_time`, `close_time`, `business_desc`, `service_state`, `service_district`, `service_city`, 
    //`line_of_activity`, `awarded`, `mobile_no`, `email`, `account_type`, `sub_type`, `verify_otp`, `login_time`SELECT * FROM `users` WHERE 1
    $posted_by="";
    if(isset($_POST['posted_by'])){
        $posted_by=trim($_POST['posted_by']);
        $sql3=$sql3." and user_id IN (select user_id from users where  sub_type='$posted_by') "; 
    }
...
if(isset($_POST['search_rent'])){
    ...
    $sql3=$sql3." and property_list='Rent' ";
...
else if(isset($_POST['search_lease'])){

    $sql3=$sql3." and property_list='Lease' ";
...
else if(isset($_POST['search_pg'])){

    $sql3=$sql3." and  property_list='Paying Guest' ";
    ...
    if(isset($_POST['property_type_house'])){
        $sql3=$sql3." and property_type='$property_type_house' ";        
    }
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12">
                ...
                <div class="subtitle">
                    <?php echo $num;?> Result Found <?php echo $search_data;?>
                </div>
